    ...
    <van-col span="24">
      <van-row>
        <van-col span="22" offset="1">
          <van-row align="center" justify="space-between">
            <van-col
              ><span class="fcff0000">*</span>&nbsp;<span
                class="font15 fc141414"
                >隐患名称</span
              ></van-col
            >
            <van-col v-if="ShowCancel">
      ...
      <van-row class="block mt10">
        <van-col span="22" offset="1" class="left font14">
          <span class="fcff0000">*</span>&nbsp;<span class="font15 fc141414"
            >隐患图片</span
          >
        </van-col>
      </van-row>
        ...
        <van-col span="22">
          <van-row class="block" align="center">
            ...
            <van-col offset="1" @click="addOthterImgs">
              <template v-if="!ModelValue.Imgs.length"
                >&nbsp;&nbsp;&nbsp;</template
              >
              <van-icon
                name="photograph"
