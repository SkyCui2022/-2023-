  ...
  <van-row>
    <van-col @click="ShowCalendar = !ShowCalendar">
      <span class="font14 fc666666">
        ...
        {{ STime }}&nbsp;至&nbsp; {{ ETime }}
        <i class="yan5 yan5-shaixuanjiantou_shaixuanjiantou font16"></i>
      </span>
    </van-col>
  </van-row>
  <van-calendar
  ...
  >
    <template #footer>
      <van-row class="block mb10" align="center" justify="space-around">
        <van-col span="8"
          ><van-button size="large" @click="cancel" round type="danger"
            ><span class="font16">清空</span></van-button
          ></van-col
        >
        <van-col span="8"
          ><van-button size="large" @click="confirm" round type="primary"
